        ...
        <>
            <div className="flex flex-col w-full">
                ...
                <div className="relative mt-2.5">
                    ...
                    className={"w-full px-4 py-3.5 text-sm text-dark_text  border-b border-light_grey2 dark:border-dark_grey focus:outline-2 focus:outline-dark_text dark:focus:outline-light_text placeholder-light_placeholder dark:placeholder-dark_placeholder dark:bg-dark_grey autofill:dark:bg-dark_grey autofill:shadow-black" + (getError().hasError ? " outline-error_color focus:outline-error_color dark:focus:outline-error_color " : "")  + (props.disabled ? "  bg-light_grey2 dark:bg-dark_grey2 cursor-not-allowed " : "")}
                    value={value}
                    onChange={(e)=>{
                        e.preventDefault()
