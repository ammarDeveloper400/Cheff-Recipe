        ...
        <Document>
            <Page size="A4" style={{padding:20}} >
                ...
                <View style={{
                    ...
                    <Link src="https://TheCheffRecipes.com">TheCheffRecipes.com</Link>
                </View>
        ...
        return (
            ...
            ">
                <span onClick={()=>{
                        ...
                        }} className="ml-2 pl-2 pr-2 pt-1 pb-1 text-primary_color text-lg cursor-pointer border-2 border-primary_color rounded-md flex flex-row items-center"><GrDownload  style={{color:colors.primary_color,marginRight:5}} /> Download</span>
                        <span></span>
                <span
                onClick={()=>{
                ...
                className="ml-2 pl-2 pr-2 pt-1 pb-1 text-primary_color text-lg cursor-pointer border-2 border-primary_color rounded-md">{"Add to wishlist"}</span>
                ...
                className="ml-2 pl-2 pr-2 pt-1 pb-1 text-primary_color text-lg cursor-pointer border-2 border-primary_color rounded-md">Share</span>
            </div>
        )
    }
    return (
        ...
        {
            isDownloadAllowed() ? (
                <PDFDownloadLink document={<MyDoc />} fileName={`${props?.recipe?.attributes?.title}.pdf`}>
                    <span onClick={()=>{
                        handleDownload()
                    }} className="ml-2 pl-2 pr-2 pt-1 pb-1 text-primary_color text-lg cursor-pointer border-2 border-primary_color rounded-md"><i className="fa fa-dollar"></i> Download</span>
                    <span></span>
                </PDFDownloadLink>
            ):(<>
                <span onClick={()=>{
        ...
        }
        {
            ...
            className="ml-2 pl-2 pr-2 pt-1 pb-1 text-primary_color text-lg cursor-pointer border-2 border-primary_color rounded-md">{saveloading ?"Loading":isSaved()?"Remvoe from wishlist":"Add to wishlist"}</span>
            ):(<>
                <span onClick={()=>{
                    saveAlert()
                    }} className="ml-2 pl-2 pr-2 pt-1 pb-1 text-primary_color text-lg cursor-pointer border-2 border-primary_color rounded-md"><i className="fa fa-dollar"></i> Add to wishlist</span>
                    <span></span>
            </>)}
            ...
            <span
                ...
                className="ml-2 pl-2 pr-2 pt-1 pb-1 text-primary_color text-lg cursor-pointer border-2 border-primary_color rounded-md">Print</span>
        </div>
    );
}
